<x-app-layout>
        ...
        <aside class="w-64 bg-white shadow-xl border-r border-indigo-100 hidden md:flex flex-col">
            ...
            <nav class="flex-1 p-4 space-y-2">
                ...
                <a href="{{ route('students.index') }}"
                   ...
                   {{ request()->routeIs('students.*') ? 'bg-indigo-600 text-white shadow-md' : 'text-gray-700 hover:bg-indigo-50 hover:text-indigo-700' }}">
                    👨‍🎓 <span class="font-medium">Students</span>
                </a>

                <a href="{{ route('courses.index') }}"
                   class="flex items-center gap-3 px-4 py-3 rounded-xl
                   {{ request()->routeIs('courses.*') ? 'bg-indigo-600 text-white shadow-md' : 'text-gray-700 hover:bg-indigo-50 hover:text-indigo-700' }}">
   ...
   {{ request()->routeIs('teachers.*') ? 'bg-indigo-600 text-white shadow-md' : 'text-gray-700 hover:bg-indigo-50 hover:text-indigo-700' }}">
    ...
    <tr class="border-t hover:bg-indigo-50 transition">
        ...
        <td class="p-4 font-semibold text-indigo-700">{{ $teacher->employee_id }}</td>
